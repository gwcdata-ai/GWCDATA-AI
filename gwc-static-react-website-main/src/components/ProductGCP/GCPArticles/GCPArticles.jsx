...
import { DomoArticlesData } from "./GCPArticlesData";
import { Col, Container, Row } from "react-bootstrap";

import styles from "./GCPArticles.module.css";
      ...
      <div className={newStyles.content2}>
        <div className={newStyles.headingAndSupportingText10}>
          <div className={newStyles.headingAndSubheading7}>
            <div className={`${styles.subheading}`}>Articles GCP</div>
            <div className={`${styles.heading}`}>
              Recent Articles Related to GCP
            </div>
          </div>
        </div>
      </div>
