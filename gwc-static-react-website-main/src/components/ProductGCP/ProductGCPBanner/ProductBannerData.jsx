...
export const AboutBannerData = {
  ...
  title:
    "Harness the power of Google Cloud to address your business challenges.",
  para: "As a Google Cloud Partner, we accelerate every organization’s ability to transform and reimagine their business through data-powered innovation digitally.",
