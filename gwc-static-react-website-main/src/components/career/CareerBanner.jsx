        ...
        <Container className="mt-4 pt-lg-5">
          <Row className="d-flex">
            <Col lg={6} md={6} className="py-lg-5 mt-5">
              ...
              <p className={`${styles.banner_title} mb-4`}>Join Us</p>
              <p className={`${styles.banner_sub_title} mb-4`}>
                Do you enjoy tackling challenges & solving intricate problems?
                Join GWC & contribute to shaping a brighter future with us!
              </p>
              <a href="#job-postings">
