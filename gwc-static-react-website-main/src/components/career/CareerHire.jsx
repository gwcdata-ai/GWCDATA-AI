...
const CareerHire = () => {
    ...
    return (
        ...
        <Container className="" >
            <Row>
                <div className="div">
                    <h3 className={` ${styles?.title2} mt-5`}>How We Hire</h3>
                    <p className={` ${styles?.card_para_title2} mt-2 mb-0`}>
                        Empower your career journey. At GWC, we seek skilled individuals who are ready to enrich their abilities with our expertise.
                    </p>
                </div>
                ...
                <Col lg={6} md={12} className='mt-2'>
                    <Card className={` ${styles?.step_card} mt-5`}>
                        <div className={` ${styles?.step_inside} `}>
                            ...
                            <p className={` ${styles?.step_para} mb-0`}>Job Opportunities & Application
                                Submission</p>
                        </div>
                    </Card>
                    ...
                    <Card className={` ${styles?.step_card} my-4`}>
                        <div className={` ${styles?.step_inside} `}>
                            ...
                            <p className={` ${styles?.step_para} mb-0`}>Shortlisting
                            </p>
                        </div>
                    </Card>
                    <Card className={` ${styles?.step_card} my-4`}>
                        <div className={` ${styles?.step_inside} `}>
                            ...
                            <p className={` ${styles?.step_para} mb-0`}>Business/Technical Interview
                            </p>
                        </div>
                    </Card>
                    <Card className={` ${styles?.step_card} my-4`}>
                        <div className={` ${styles?.step_inside} `}>
                            ...
                            <p className={` ${styles?.step_para} mb-0`}>HR Interview
                            </p>
                        </div>
                    </Card>
                    <Card className={` ${styles?.step_card} my-4`}>
                        <div className={` ${styles?.step_inside} `}>
                            ...
                            <p className={` ${styles?.step_para} mb-0`}>Decision & Offer
                            </p>
                        </div>
                    </Card>
                ...
                <Col lg={6} md={12}>
                    <Card className={` ${styles?.step_card2} mt-5`}>
                        <div className={` ${styles?.card_inside} `}>
                            ...
                            <p className={` ${styles?.img_para} my-3`}>A Recruiter/Technical panel will screen your application. We will contact you for further details if your credentials match our requirements.</p>
