    ...
    <Container fluid className="pt-2 pb-5">
      <section className="">
        <Container className="mt-5">
          ...
          <Row className="">
            <Col md={6} className="px-md-5 mb-4" data-aos="fade-left">
              <div className="mt-lg-5">
                <h1 className={` ${styles?.title} mt-lg-5`}>
                  DOMO's Trusted Partner
                </h1>

                <p className={styles?.text}>
                  As a partner of DOMO and boasting a team of certified experts,
                  GWC invites you to inquire about any topic and we shall have
                  it done using DOMO. Leveraging DOMO's powerful analytics
                  platform, we help clients enhance their processes, identify
                  areas for improvement, and implement strategic solutions to
                  achieve operational excellence while simultaneously reducing
                  costs.
                </p>
                ...
                <Row>
                  <Col md={4} xs={4}>
                    <img src={certi2} alt="" className="w-100 mt-3" />
                  </Col>
                  <Col md={4} xs={4}>
                    <img src={certi3} alt="" className="w-100 mt-3" />
                  </Col>
                  <Col md={4} xs={4}>
                    <img src={certi1} alt="" className="w-100 mt-3" />
                  </Col>
                </Row>
              </div>
            </Col>
