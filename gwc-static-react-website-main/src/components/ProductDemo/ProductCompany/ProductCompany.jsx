...
const DoMoreWithDomo = [
  {
    ...
    description_title:
      "Unlock the power of date immersion with Domo's App Studio - now available for all customers !",
    description_list: [
    ...
    image: img1,
    learnMore:
      "https://www.domo.com/product/new-features#domopalooza-2024-app-studio",
    alt: "Domo App Studio",
  },
  {
    id: 2,
    ...
    name: "Domo Workflows",
    description_title:
      "Simplify and streamline data-driven processes effortlessly",
    description_list: [
    ...
    image: img2,
    learnMore:
      "https://www.domo.com/product/new-features#domopalooza-2024-domo-workflows",
    alt: "Domo Workflows",
  },
  {
    id: 3,
    ...
    image: img3,
    learnMore:
      "https://www.domo.com/product/new-features#domopalooza-2024-domo-ai-model-management",
  },
  {
    id: 4,
    className: "fourth",
    ...
    image: img4,
    learnMore:
      "https://www.domo.com/product/new-features#domopalooza-2024-domo-cloud-amplifier",
  },
];
    ...
    <Container fluid className="pt-1 pb-10 mt-4">
      {isMobile ? (
        <p
          ...
          style={{ paddingLeft: "13px", paddingBottom: "10px" }}
        >
          Do more with Domo
        </p>
      ) : null}
      ...
      <section className="">
        <Container className={`${styles.DataGovernanceListCards}`}>
          {isMobile ? (
            ...
            <Row className="">
              <p className={styles?.title} style={{ padding: "13px" }}>
                Do more with Domo
              </p>
              {DoMoreWithDomo?.map((item, index) => {
                return (
