          ...
          <Row className="d-flex align-items-center justify-content-center">
            <Col md={12} className="mb-4 mt-md-0 mt-5">
              ...
              <p className={styles?.sub_main_title}>
                As a Snowflake partner, our distinctiveness lies in certified
                expertise, a proven track record, & a client-centric approach.
                We offer tailored solutions, stay innovative, & prioritize
                collaboration. Our comprehensive services cover the entire
                Snowflake spectrum, ensuring clients derive maximum value. With
                agility, responsiveness, & global reach, we position ourselves
                as thought leaders, providing clients with a competitive edge in
            ...
            {isMobile ? (
              <Col xs={12} md={6} lg={3} className="w-100">
                <Slider {...settings} className="">
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText1({
                        text: "Our Snowflake services optimize complex queries, significantly improving query execution times & overall system performance.",
                  ...
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText2({
                        text: "We implement cost-effective solutions by leveraging Snowflake's separation of storage & compute resources, resulting in optimized resource utilization & cost savings.",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
                      setHoveredText2({ text: "Cost Optimization", style: {} })
                    }
                  >
                    <div className="overlay_container">
                      <img
                  ...
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText3({
                        text: " We design & implement highly efficient & scalable data models in Snowflake, enhancing data organization & accessibility for analytics & reporting.",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
                  ...
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText4({
                        text: "We implement robust security measures, including role-based access control (RBAC), encryption, & data masking, ensuring data integrity & compliance with security st&ards. ",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
                  ...
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText5({
                        text: "Our services streamline ETL processes, reducing data processing times & improving the efficiency of data movement within the Snowflake platform.  ",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
                  ...
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText6({
                        text: "We integrate Snowflake with various Business Intelligence (BI) tools, enabling seamless data visualization & reporting capabilities for end-users. ",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
              ...
              <>
                <Col
                  ...
                  onMouseOver={() =>
                    setHoveredText1({
                      text: "Our Snowflake services optimize complex queries, significantly improving query execution times and overall system performance.",
                      style: hoveredTextStyle,
                    })
                  }
                  onMouseOut={() =>
                ...
                <Col
                  ...
                  onMouseOver={() =>
                    setHoveredText5({
                      text: "Our services streamline ETL processes, reducing data processing times and improving the efficiency of data movement within the Snowflake platform. ",
                      style: hoveredTextStyle,
                    })
                  }
                  onMouseOut={() =>
