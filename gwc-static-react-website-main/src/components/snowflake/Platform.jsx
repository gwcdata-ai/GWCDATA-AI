          ...
          <Row className="d-flex align-items-center justify-content-center my-5">
            ...
            >
              <div className="">
                ...
                <p className={styles?.title}>Unleash the Power of Data</p>

                <p className={styles?.text}>
                  Snowflake, a cloud-based data warehousing platform, provides a
                  range of offerings to help organizations manage and analyze
                  their data efficiently. We ensure your cloud operations run
                  smoothly and reliably, so you can focus on your business
                  goals.
                </p>
            ...
            <Col xs={12} lg={6} md={6} className="px-md-0" data-aos="fade-left">
              <img
                src={image1}
                alt="Snowflake, a cloud-based data warehousing platform"
