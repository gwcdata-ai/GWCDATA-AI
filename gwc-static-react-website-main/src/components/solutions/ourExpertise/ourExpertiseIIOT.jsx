...
export const OurExpertiseIIOT = ({ ourExpertiseContent }) => {
          ...
          <Row className="d-flex align-items-center justify-content-center">
            ...
            {ourExpertiseContent?.list?.map((item, index) => (
              <Col
                ...
                data-aos="zoom-in"
              >
                <div className={`${styles.card_section_iiot} mb-2`}>
                  <Image
                    src={item?.img}
                  ...
                  <h2
                    className={`${styles.card_title} mt-2 mb-3`}
                    dangerouslySetInnerHTML={{
                      __html: item?.title?.replace(/\n/g, ""),
                    }}
                  />
                  <p className={`${styles.card_text} mb-0`}> {item?.text}</p>
                </div>
              </Col>
            ))}
          </Row>
