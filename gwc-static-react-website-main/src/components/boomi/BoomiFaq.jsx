        ...
        <Container className="" id="bi-analytics">
          <Row className="d-flex align-items-center justify-content-center">
            <Col lg={12} xs={12} className="py-md-0 py-0 ">
              <h1 className={`mt-2 ${styles?.title4}`}>Features of Boomi</h1>
              <p className={` ${styles?.title5} mb-4 `}>
                Boomi is a cloud-native platform, offering scalability,
                flexibility, and ease of deployment. Boomi prioritizes data
                security, offering robust encryption and compliance with
                industry standards to protect your sensitive information. Its
                features include:
              </p>
                ...
                <Col md={8}>
                  <Accordion defaultActiveKey="0">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        Design and deploy integrations effortlessly with Boomi's
                        intuitive interface, no extensive coding required.
                      </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="1">
                      ...
                      <Accordion.Body>
                        Access a vast library of pre-built connectors,
                        accelerating integration development and reducing time
                        to market.
                      </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="2">
                      ...
                      <Accordion.Body>
                        Monitor your integrations in real-time, ensuring optimal
