        ...
        <Container className=" mt-0">
          <Row className="d-flex align-items-center justify-content-center my-2">
            <Col xs={12} lg={6} className="pt-md-0 pt-2" data-aos="fade-right">
              <div className="">
                <h2 className={styles?.title}>GCU Puraskar</h2>
                <p className={styles?.text}>
                  Honoured to receive GCU Puraskar 2022 from Garden City
                  University, Bangalore for contribution in the field of
          ...
          <Row className="d-flex align-items-center justify-content-center my-5">
            ...
            <Col xs={12} lg={6} md={6} className="px-md-0" data-aos="fade-left">
              <div className="px-lg-5">
                <h2 className={styles?.title}>Young Entrepreneur</h2>
                <p className={styles?.text}>
                  This award for Young Entrepreneur in Tirupattur District was
                  received from Vendhar TV.
                </p>
              </div>
            </Col>
          </Row>
