...
const AlationCards = () => {
    ...
    return (
        ...
        <Container className="pt-2 pb-4">
            <Row className='mt-5'>
                <Col md={12}>
                    <h3 className={styles.title_head}>Foster a culture of data-driven decision-making and unlock new opportunities with Alation</h3>
                    <p className={` ${styles.para} mb-3 `}>
                        Streamline your workflows and accelerate research with fast and accurate data retrieval. GWC partners with Alation to drive strategic growth and optimize performance through informed decisions based on comprehensive data insights. Through collaborative services from Alation, we foster a culture of shared ownership and collective success. 
                    </p>
                </Col>
            </Row>
            <section className="">
                                ...
                                <Card onClick={handleC1Click} className={` ${styles.five_card} mb-3 `}>
                                    <Card.Text>
                                        <div className={` ${styles.text_icon} mb-2`}>
                                            ...
                                            <p className={` ${styles.card_para1} mb-3 `}>Manage workflows</p>
                                        </div>
                                ...
                                <Card onClick={handleC2Click} className={` ${styles.five_card} mb-3 `}>
                                    <Card.Text>
                                        <div className={` ${styles.text_icon} mb-2`}>
                                            ...
                                            <p className={` ${styles.card_para1} mb-3 `}>Monitor workflows</p>
                                        </div>
                                        <p className={` ${styles.card_para2} mb-3 `}>
                                ...
                                <Card onClick={handleC3Click} className={` ${styles.five_card} mb-3 `}>
                                    <Card.Text>
                                        <div className={` ${styles.text_icon} mb-2`}>
                                            ...
                                            <p className={` ${styles.card_para1} mb-3 `}>Get Slack alerts</p>
                                        </div>
                                        <p className={` ${styles.card_para2} mb-3 `}>
