      ...
      <section className="">
        <Container className="mt-md-4 mt-0">
          <Row className="d-flex align-items-center justify-content-center my-lg-5">
            ...
            >
              <div className="">
                <h1 className={styles?.title}>What is Alation?</h1>
                ...
                <p className={styles?.text}>
                  ...
                  that organizes your company's data, highlighting hidden assets
                  and making them easy to find and understand. Think of it as an
                  intelligent librarian for your information, ensuring its
                  quality, security, and accessibility for everyone. With
                  Alation, collaboration thrives, insights blossom and your data
                  transforms from confusion to fuel for smarter decisions and
                  business success.
                </p>
