        ...
        <Container className="py-4 mt-md-0 mt-4">
          <Row className="d-flex">
            <Col lg={7} md={6} className="py-lg-5">
              ...
              <p className={`${styles.banner_title} mb-4`}>DBT</p>
              <p className={`${styles.banner_sub_title} mb-4`}>
                A robust framework that enables you to transform data within
                your warehouse using SQL more effectively & also helps your
                organization to build, test, & maintain its data infrastructure.
              </p>
            </Col>
            <Col lg={5} md={6}>
