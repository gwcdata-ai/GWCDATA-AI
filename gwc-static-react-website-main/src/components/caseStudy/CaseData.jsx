...
export const CaseListData = [
  {
    ...
    topHeading:
      "From Cost Reduction to Collaboration: A leading Digital Skill Training firms LMS Success Story",
    alt: "From Cost Reduction to Collaboration: A leading Digital Skill Training firms LMS Success Story",
    caseTopImg: te2,
    caseSubPara:
...

  {
    ...
    img: img2,
    alt: "How Data Analytics Transformed Restaurant Experiences and Redefined Dining for a Restaurant Collective",
    topHeading:
      "How Data Analytics Transformed Restaurant Experiences and Redefined Dining for a Restaurant Collective",
    caseTopImg: im2,
    caseSubPara:
  ...
  },
  {
    ...
    topHeading:
      "Enhanced Security Measures, Streamlined Communication: A Case Study on How GWC Data.AI Empowered a Cybersecurity Solutions Systems by Merging WhatsApp with Salesforce",
    caseTopImg: ac2,
    alt: "Enhanced Security Measures, Streamlined Communication: A Case Study on How GWC Data.AI Empowered a Cybersecurity Solutions Systems by Merging WhatsApp with Salesforce",
    caseSubPara:
  ...
  },
  {
    ...
    topHeading:
      "A Case Study On Enhancing Sales Performance Of A Global Industrial Software Leader Through Salesforce Analytics Studio",
    alt: "A Case Study On Enhancing Sales Performance Of A Global Industrial Software Leader Through Salesforce Analytics Studio",
    caseTopImg: hv2,
    caseSubPara:
  ...
  },
  {
    ...
    alt: "ABC-XYZ Inventory Analysis",
    caseTopImg: abc2,
    caseList: [
      {
        id: 1,
...

  {
    ...
    alt: "Crafting Business Brilliance with BI for IT Management Software Suppliers",
    img: img11,
    topHeading:
      "Crafting Business Brilliance with BI for IT Management Software Suppliers",
    caseTopImg: hr2,
  ...
  },
  {
    ...
    alt: "Advanced Analytics Implementation for Home Furnishing Retail",
    caseTopImg: hr2,
    caseSubHeading: "Overview:",
    caseSubPara:
  ...
  },
  {
    ...
    alt: "Migrating Reports from MicroStrategy to Power BI",
    caseTopImg: hr2,
    caseSubHeading: "Overview:",
    caseSubPara:
  ...
  },
  {
    ...
    alt: "Workplace Analytics for Manufacturing Industry",
    img: img14,
  ...
  },
  {
    ...
    alt: "Task Management Transformed: A Power Apps Success Story",
    caseTopImg: hr2,
    caseSubHeading: "Overview:",
    caseSubPara:
  ...
  },
  {
    ...
    alt: "Oil and Gas Company Data Analysis",
    caseTopImg: hr2,
    caseSubHeading: "Overview:",
    caseSubPara:
  ...
  },
  {
    ...
    heading:
      "From Kitchen to Table: Any day Group's Culinary Journey Enhanced by GWC Analytics Data-Driven",
    img: hr8,
    topHeading:
      "From Kitchen to Table: Any day Group's Culinary Journey Enhanced by GWC Analytics Data-Driven",
    alt: "From Kitchen to Table: Any day Group's Culinary Journey Enhanced by GWC Analytics Data-Driven",
    caseTopImg: hr8,
    caseSubHeading: "Overview:",
    caseSubPara:
  ...
  },
  {
    ...
    alt: "GWC Analytic's Impact on Home Retailer Operations and Success",
    caseTopImg: c14,
    caseSubHeading: "Overview:",
    caseSubPara:
  ...
  },
  {
    ...
    heading:
      "Navigating Success with Workplace Analytics in Manufacturing Operations",
    img: c15,
    topHeading:
      "Navigating Success with Workplace Analytics in Manufacturing Operations",
    alt: "Navigating Success with Workplace Analytics in Manufacturing Operations",
    caseTopImg: c15,
    caseSubHeading: "Overview:",
    caseSubPara:
    ...
    caseList: [
      ...
      },
      {
        ...
        listHeading: "Benefits",
        listPara:
          "After implementing workplace analytics and making data-driven changes by GWC, the client experienced several positive outcomes:",
        listPoints: [
      ...
      },
      {
        id: 3,
        listPara:
          "Employee feedback has been used as a key feed to the management during the hybrid model for seamless onboarding process and other trainings. ",
      },
      {
        id: 4,
        listHeading: "The Results ",
  ...
  },
  {
    ...
    alt: "Empowering Production Efficiency using IoT",
    caseTopImg: c16,
    ...
    caseList: [
      {
        ...
        listSub: "Company",
        listPara:
          "Alubee die casters are one of the leading aluminium die casters in India for more than two decades. The core strength of Alubee is the ability to offer as a one – attracting solution for all the high pressure die casting needs",
      },
      {
        id: 2,
        listSub: "Context",
        listPara:
          "Alubee is currently taking significant strides towards the automation of its production environment. The company aims to enhance efficiency, optimize processes, and elevate overall productivity.​",
      },
      {
        id: 3,
      ...
      },
      {
        ...
        listPara:
          "Many existing die casting machines may be equipped with legacy control systems that are not inherently designed for IoT integration.",
      },
      {
        id: 6,
        listSub: "Skill and Knowledge Gaps",
        listPara:
          "Integrating IoT technologies requires a certain level of expertise, both in IT and industrial processes. The workforce may need to handle the new technologies, and finding skilled personnel can be a challenge.​",
      },
      {
        id: 7,
        listSub: "Real-time Data Processing",
        listPara:
          "IoT applications often require real-time or near-real-time processing to enable timely decision-making. Designing a data pipeline that can handle and process data streams in real time introduces challenges in terms of latency and system responsiveness.​",
      },
      {
        id: 8,
  ...
  },
  {
    ...
    alt: "Mobile Manufacturing: Demand Forecasting & Supply Chain",
    caseTopImg: c17,
    caseSubHeading: "Overview:",
    caseSubPara:
    ...
    caseList: [
      ...
      },
      {
        ...
        listHeading: "The Solution",
        listPara:
          "Customer Company decided to harness the power of data to address their supply chain inventory and demand forecasting challenges. They embarked on a journey to integrate their MES, PIWEB systems with Tableau, a business intelligence and analytics tool known for its capabilities in turning data into actionable insights.",
        listPoints: [
  ...
  },
  {
    ...
    alt: "US Healthcare Insurance, claim and Risk Data Analysis",
    caseTopImg: c18,
    caseSubHeading: "Overview:",
    caseSubPara:
    ...
    caseList: [
      ...
      },
      {
        ...
        listHeading: "The Solution",
        listPara:
          "Customer need a Cloud data warehouse solution to store data from several subsidiary companies and for speedier analysis.",
        listPoints: [
...

      {
        ...
        listHeading: "The Results ",
        listPara:
          "Customer has successfully implemented an Azure-based data management solution, resulting in significant improvements:",
        listPoints: [
      ...
      },
      {
        ...
        listSub: "Architecture",
        listPara:
          "We have transitioned from our previous on-premises architecture to an Azure-based environment, and the implemented architecture has been effectively deployed and operational.",
        images: [Picture3],
      },
    ],
  },
  {
    ...
    alt: "Transforming Data Auditing with Power Apps",
    img: c19,
    ...
    caseList: [
      ...
      },
      {
        ...
        listHeading: "The Solution",
        listPara:
          "Customer embarked on a groundbreaking journey to conquer their data auditing challenges. Harnessing the immense power of Microsoft's Power Platform, they crafted a cutting- edge auditing application that's not only robust but also incredibly user-friendly.",
        listPoints: [
  ...
  },
  {
    ...
    alt: "Customer Complaint Handling with Power Platform",
    img: c20,
    ...
    caseList: [
      {
        ...
        listHeading: "The Challenge",
        listPara:
          "To create a software solution that comprehensively monitors the entire Regulatory Assurance process, aiming to minimize manual tasks, boost productivity, and ultimately improve overall operational efficiency and financial outcomes.",
      },
      {
        id: 2,
        listHeading: "The Solution",
  ...
  },
  {
    ...
    alt: "Harnessing Salesforce Customization for CRM Transition",
    caseTopImg: c21,
    caseSubHeading: "Overview:",
    caseSubPara:
    ...
    caseList: [
      ...
      },
      {
        ...
        listHeading: "Benefits",
        listPara:
          "The implementation of the innovative Salesforce customization solution yielded impressive results for the client: ",
        listPoints: [
      ...
      },
      {
        ...
        listHeading: "The Results",
        listPara:
          "In overcoming the challenge of high Salesforce license costs, our innovative solution of leveraging Salesforce customization to replicate the functionalities of Salesforce Sales Cloud proved to be a game-changer for the client. By aligning with their budget constraints and providing a seamless transition for their sales operations, we showcased the power of tailoring technology solutions to meet unique business needs. This case study serves as a testament to the trans- formative potential of customization within the CRM landscape.",
      },
    ],
  },
  {
    ...
    img: c22,
    topHeading:
      "Enhancing Sales Performance through Salesforce Analytics Studio",
    alt: "Enhancing Sales Performance through Salesforce Analytics Studio",
    ...
    caseList: [
      {
        ...
        listHeading: "The Challenge",
        listPara:
          "Being a direct-to-consumer brand presented unique challenges, including:",
        listPoints: [
      ...
      },
      {
        ...
        listHeading: "The Solution",
        listSub:
          "Salesforce Analytics Studio Solution: Revolutionizing Sales Analytics:",
        listPara:
          "Organization decided to leverage Salesforce Analytics Studio to address their sales analytics challenges and enhance their data-driven decision-making capabilities",
        listPoints: [
  ...
  },
  {
    ...
    alt: "Strengthening Cyber Security Business with WhatsApp",
    img: c23,
    ...
    caseList: [
      {
        ...
        listHeading: "The Challenge",
        listPara:
          "As a cybersecurity company, facing unique challenges is inherent to our operations, such as:",
        listPoints: [
  ...
  },
  {
    ...
    img: c24,
    alt: "Teqcertify Academy’s LMS Development",
  ...
  },
  {
    ...
    img: c25,
    alt: "Financial Performance Analysis",
    ...
    caseList: [
      {
        ...
        listHeading: "The Challenge",
        listPara:
          "Being a software solutions and services has its unique challenges, such as:",
        listPoints: [
