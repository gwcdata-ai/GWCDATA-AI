                ...
                <Row>
                    <Col md={12}>
                        ...
                        <Row className={styles.section}>
                            <div className="mt-0">
                                <img src={item?.caseTopImg} alt="image" className='my-4 w-100' />
                                <h3 className={` ${styles.blog_main_para} `}>{item?.caseSubHeading}</h3>
                                ...
                                <ul className={` ${styles.list_section}`}>
                                    {item.caseList.map((data) => {
                                        const { id, listHeading, listPara, images, listSub, listPoints } = data;
                                        return (
                                            <>
                                                <li key={id}>
                                                    {listHeading && (
                                                        <h6 className={` ${styles.blog_next_para} mb-3`}>{listHeading}</h6>

                                                    )}
                                                    {listSub && (
                                                        <h6 className={` ${styles.blog_next_para2}`}>{listSub}</h6>
