...
import blogDay from "../../assets/images/Blog/blogDay.png";
...
export const BlogCardData = [
  ...
  },
  {
    id: 3,
    date: "January 08, 2024",
    heading: "Lorem ipsum dolor sit amet consectetur. Interdum velit quis sed.",
    days: "Few days ago",
    // views: "110k views",
    img: cardImg2,
  },
...
export const BlogTeamData = {
  ...
  title: "Explore Our Blogs for Expert Perspectives",
  description:
    "Stay informed with our diverse range of blog posts covering industry trends, tips, and insights. Discover thought-provoking articles on data science and AI crafted to inspire business success.",
...
export const BlogCardData3 = [
  ...
  //   id: 2,
  //   topHeading:
  //     "Business Intelligence & Analytics: Our cutting-edge data analytics and business intelligence solutions",
  ...
  //   topHeading:
  //     "Deep Link Filters in DOMO : It may sound complex, but at its core",
  //   days: "Few days ago",
  //   // views: "15k views",
  ...
  // },
  {
    ...
    days: "Few days ago",
    topHeading:
      "Harnessing the Power of Domo for Streamlined Manufacturing Operations: Domo stands out due to its robust capabilities in data integration, data warehousing, data governance, artificial intelligence (AI), machine learning (ML), data visualization, workflow automation, and data-driven applications",
    // views: "15k views",
