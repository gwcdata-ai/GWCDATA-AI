      ...
      <section className="">
        <Container className="mt-md-4 mt-0">
          <Row className="d-flex align-items-center justify-content-center my-5">
            <Col md={7} className="pt-md-0 pt-4" data-aos="fade-right">
              <div className="px-4">
                ...
                <p className={styles?.text}>
                  We’ve automated the most time-consuming parts of the ELT
                  process so the data engineers can focus on higher-impact
                  projects with total peace of mind. Fivetran can help you
                  create dashboards and metrics, reduce costs and time, and
                  improve data literacy and insights.
                </p>
            ...
            <Col md={5} className="px-md-0" data-aos="fade-left">
              <img
                src={image1}
                alt="Fivetran's data platform allows you to automatically extract and load data from over 400 sources."
