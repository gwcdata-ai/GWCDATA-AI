...
const FiveOperations = () => {
  ...
  return (
    <Container className="pt-2 pb-4" id="simplify-data-extraction">
      <Row className="mt-5">
        <Col md={12}>
          <h2 className={styles.title_head}>Simplify Data Extraction</h2>
          <p className={` ${styles.para} mb-3 `}>
            Easily extract data from various sources without writing code, using
            Fivetran’s more than 300 connectors for popular applications,
            databases, files and events. We can also build custom connectors
            using Fivetran’s REST API or SDK.
          </p>
        </Col>
      </Row>
      <section className="">
        <Container className="mt-md-4 mt-0">
          <Row className="d-flex align-items-center justify-content-center my-5">
            <Col lg={6} md={12} className="pt-md-0 pt-4" data-aos="fade-right">
              {showC1 && (
                <img
                  src={c1}
                  alt=""
            ...
            <Col lg={6} md={12} className="px-md-0" data-aos="fade-left">
              ...
              >
                ...
                <Card.Text>
                  ...
                  <p className={` ${styles.card_para2} mb-3 `}>
                    We can speed up data transformation and analysis using
                    Fivetran’s pre-built data models that cover common use cases
                    and best practices.
                  </p>
                </Card.Text>
              </Card>
              ...
              >
                ...
                <Card.Text>
                  ...
                  <p className={` ${styles.card_para2} mb-3 `}>
                    Fivetran handles all the tasks, such as schema detection,
                    data type conversion, error handling, incremental loading,
                    and schema changes automatically.
                  </p>
                </Card.Text>
              </Card>
              ...
              >
                ...
                <Card.Text>
                  ...
                  <p className={` ${styles.card_para2} mb-3 `}>
                    Fivetran can capture changes in the source data using
                    log-based or trigger-based methods and apply them to the
