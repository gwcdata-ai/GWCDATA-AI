                    ...
                    <Row className="d-flex">
                        <Col lg={7} md={6} className="py-lg-5">
                            ...
                            <p className={`${styles.banner_sub_title} mb-4`} >
                                Unlock the Power of Data-driven Insights with Looker Business Intelligence.
                            </p>
                            <p className={`${styles.looker_banner_para} mb-0`}>At GWC, we believe in harnessing the full potential of your data to drive informed decision-making. Our Looker BI solution empowers your team to explore, analyse, and visualize data seamlessly.</p>
