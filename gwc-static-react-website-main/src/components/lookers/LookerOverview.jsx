        ...
        <Container className="GCPOverview">
          <Row className="d-flex align-items-center justify-content-center">
            <Col md={12} className="mb-4 mt-md-0 mt-5">
              ...
              <h2 className={styles?.title}>Why Choose GWC for Looker BI?</h2>
              <p className={styles?.sub_main_title}>
                We access your business and its pain points, build KPIs and
                wireframes which relieves those identified pain areas and then
                turn the imagined wireframes into real dashboards which then be
                presented to the leaders in the organisation.
              </p>
            </Col>
            {isMobile ? (
              <Col xs={12} md={6} lg={3} className="w-100">
                <Slider {...settings} className="">
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText1({
                        text: "Over 30 Looker certified experts. Our dedicated support team is here to assist you at every step, ensuring a smooth and successful integration.",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
                      setHoveredText1({ text: "Expert Support", style: {} })
                    }
                  >
                  ...
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText2({
                        text: " We understand that every business is unique. Our Looker BI solutions are customizable to fit your specific requirements.",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
                      setHoveredText2({ text: "Tailored Solutions", style: {} })
                    }
                  >
                    <div className={styles.imageContainer}>
                      <div className={styles.gradientOverlay}></div>
                  ...
                  <Col
                    ...
                    onMouseOver={() =>
                      setHoveredText3({
                        text: "Join a growing list of satisfied clients who have transformed their data into actionable insights with GWC and Looker BI. ",
                        style: hoveredTextStyle,
                      })
                    }
                    onMouseOut={() =>
                      setHoveredText3({ text: "Proven Success", style: {} })
                    }
                  >
                    <div className={styles.imageContainer}>
                      <div className={styles.gradientOverlay}></div>
