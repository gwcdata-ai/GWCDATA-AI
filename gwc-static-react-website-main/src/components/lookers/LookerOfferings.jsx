            ...
            <Col lg={5} md={6} className="px-0" data-aos="fade-right">
              <div className={styles.platformDataSection}>
                ...
                <p className={styles?.text}>
                  Looker offers more than just a contemporary business
                  intelligence platform. You have the flexibility to utilize
                  Looker for self-service or governed BI, develop custom
                  applications with reliable metrics, or seamlessly integrate
                  Looker modeling into your current BI environment.
                </p>
                <p className={styles?.text}>
                  Gain access to, analyze, and utilize the latest trusted
                  version of your data. Deliver scalable, trusted data
                  experiences from the cloud platform of your preference,
                  empowering your users with real-time insights to act upon.
                </p>
              </div>
            </Col>
                  ...
                  <Col lg={4} md={4} sm={6} xs={6} className="mt-4 ">
                    <div className={styles.offeringCards}>
                      <Image
                        ...
                        className={`mt-2 ${styles.imageCard}`}
                      />
                      <h3 className={styles.imageCardText}>Data Modeling</h3>
                    </div>
                  </Col>
                  <Col lg={4} md={4} sm={6} xs={6} className="mt-4 ">
                    <div className={styles.offeringCards}>
