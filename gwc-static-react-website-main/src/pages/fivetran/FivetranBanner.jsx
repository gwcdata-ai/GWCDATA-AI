        ...
        <Container className="py-4 mt-md-0 mt-4">
          <Row className="d-flex">
            <Col lg={7} md={6} className="py-lg-5">
              ...
              <h2 className={`${styles.banner_title} mb-4`}>Fivetran</h2>
              <p className={`${styles.banner_sub_title} mb-4`}>
                Fivetran is a modern, cloud-based, automated data-movement
                platform that can extract, load & transform data from various
