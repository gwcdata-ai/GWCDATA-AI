...
const SalesforceBanner = () => {
  ...
  return (
    ...
    >
      ...
      >
        <source src={SalesforceGIF2} type="video/mp4" />
      </video>
      <div
        style={{
          position: "absolute",
        ...
        <Container className="py-4 mt-md-0 mt-4">
          <Row className="d-flex">
            <Col lg={7} md={6} className="pt-lg-5">
              ...
              <h2 className={`${styles.banner_title} mb-4`}>Salesforce</h2>
            ...
            <Col
              lg={5}
              md={6}
              className={`${isMobile ? null : `${styles1.paddingTop_Mobile}`}`}
            >
              <img
                src={Sales_force_GIF_New}
                alt="logo"
                className={`${
                  isMobile
                    ? `mt-lg-4 ${styles1.GIF_Width_Mobile}`
                    : `${styles1.GIF_Width_Desktop}`
                }`}
              />
            </Col>
          </Row>
