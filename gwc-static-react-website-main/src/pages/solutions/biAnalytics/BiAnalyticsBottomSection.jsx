...
const BiAnalyticsBottomSection = () => {
  return (
          ...
          <Row className="d-flex">
            <Col lg={7} className="py-lg-3 px-0">
              ...
              <p className={`${styles.banner_para} mb-4`}>
                Contact us today to schedule a consultation and discover how GWC
                DATA.AI can help you unleash the power of your data.
              </p>
              <Link to="/contact-us">
...
export default BiAnalyticsBottomSection;
