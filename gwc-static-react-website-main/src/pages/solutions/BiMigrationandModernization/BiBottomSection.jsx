          ...
          <Row className="d-flex">
            <Col lg={7} className="py-lg-3 px-0">
              ...
              <p className={`${styles.banner_para} mb-4`}>
                Ready to take your BI system to the next level? Contact us today
                to learn more about our BI migration and modernization services
                and how we can help you unlock the full potential of your data.
              </p>
              <Link to="/contact-us">
...
export default BiBottomSection;
